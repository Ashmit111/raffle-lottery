...
contract FundSubscription is CodeConstants, Script {
    ...
    function fundSubscriptionUsingConfig() public {
        ...
        if(subId == 0) {
            CreateSubsciption createSub = new CreateSubsciption();
        ...
        fundScription(vrfCoordinatorV2_5, subId, link, account);
    }

    function fundScription(adress vrfCoordinatorV2_5, uint256 subId, address link, address account) public {
